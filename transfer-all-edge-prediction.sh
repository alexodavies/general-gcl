...
do
    python edge_prediction_transfer.py --checkpoint "$checkpoint_name" --epochs 10 --backbone gin --batch_size 512
done

python edge_prediction_transfer.py --checkpoint edge-views-all.pt --epochs 10 --backbone gin --batch_size 512 -f
