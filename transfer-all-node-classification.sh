...
do
    python node_classification_transfer.py --checkpoint "$checkpoint_name" --epochs 10 --backbone gin
done

python node_classification_transfer.py --checkpoint edge-views-all.pt --epochs 10 --backbone gin -f
