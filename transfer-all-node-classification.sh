...
do
    python node_classification_transfer.py --checkpoint "$checkpoint_name" --epochs 10 --backbone gin  --batch_size 512
done

#for checkpoint_name in  untrained all-100.pt chem-100.pt social-100.pt edge-views-all.pt
#do
python node_classification_transfer.py --checkpoint edge-views-all.pt --epochs 10 --backbone gin -f  --batch_size 512
#done
